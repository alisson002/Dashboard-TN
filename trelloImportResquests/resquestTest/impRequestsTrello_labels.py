        ...
        for card in todas_as_pautas:
            ...
            for membros in card['idMembers']: 
                ...
                if card['idLabels'] == []:
                    ...
                    csvwriter.writerow([membros, membros_nomes.get(membros), card['name'], card['shortUrl'], card['dateLastActivity'], 'Pauta sem editoria', 0])
                    ...
                    for lbl in card['idLabels']:
                        ...
                        csvwriter.writerow([membros, membros_nomes.get(membros), card['name'], card['shortUrl'], card['dateLastActivity'], editoria.get(lbl), int(freq_edi.get(lbl))])
