...
def crescimento(atual, antFBo):
    taxa = ((atual - antFBo) / abs(antFBo))
    if taxa > 0:
...
def fbMetrics(dados_FB_alcance_ANTERIOR,dados_FB_alcance_FILTRADAS,visitasFB_ANTERIOR,visitasFB_FILTRADO,seguidoresFB_ANTERIOR,seguidoresFB_FILTRADO):
    ...
    total_FBVisitas_selecionado = visitasFB_FILTRADO['Primary'].sum()
    total_FBVisitas_anterior = visitasFB_ANTERIOR['Primary'].sum()
...
def FBMedias_alcance(dados_FB_alcance_FILTRADAS):
    ...
    col1.metric("Período selecionado (dia)", formataNumero(int(dados_FB_alcance_FILTRADAS['Primary'].sum()/len(dados_FB_alcance_FILTRADAS['Primary']))), '')
    
    col2.metric("Diária", formataNumero(int(alcanceFB_semZeros['Primary'].sum()/dias)), '')
    
    col3.metric("Semanal (7 dias)", formataNumero(int(alcanceFB_semZeros['Primary'].sum()/semanas)), '')
    
    col4.metric("Mensal (30 dias)", formataNumero(int(alcanceFB_semZeros['Primary'].sum()/mês)), '')
...
def FBMedias_visitas(visitasFB_FILTRADO):
    ...
    col1.metric("Período selecionado (dia)", formataNumero(int(visitasFB_FILTRADO['Primary'].sum()/len(visitasFB_FILTRADO['Primary']))), '')
    
    col2.metric("Diária", formataNumero(int(visitasFB_semZeros['Primary'].sum()/dias)), '')
    
    col3.metric("Semanal (7 dias)", formataNumero(int(visitasFB_semZeros['Primary'].sum()/semanas)), '')
    
    col4.metric("Mensal (30 dias)", formataNumero(int(visitasFB_semZeros['Primary'].sum()/mês)), '') 
...
def FBMedias_seguidores(seguidoresFB_FILTRADO):
    ...
    col1.metric("Período selecionado (dia)", formataNumero(int(seguidoresFB_FILTRADO['Primary'].sum()/len(seguidoresFB_FILTRADO['Primary']))), '')
    
    col2.metric("Diária", formataNumero(int(seguidoresFB_semZeros['Primary'].sum()/dias)), '')
    
    col3.metric("Semanal (7 dias)", formataNumero(int(seguidoresFB_semZeros['Primary'].sum()/semanas)), '')
    
    col4.metric("Mensal (30 dias)", formataNumero(int(seguidoresFB_semZeros['Primary'].sum()/mês)), '')
